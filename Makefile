...
#
PHP_INCLUDE=$(shell php-config --includes)

#COMPILER_FLAGS=-Wall -c -O2 -std=c++11 -fpic ${PHP_INCLUDE} -I/usr/local/FrontBase/include -I./include -o
COMPILER_FLAGS=-Wall -c -O2 -std=c++11 -fpic ${PHP_INCLUDE} -I/usr/local/FrontBase/include -o
LINKER_FLAGS=-shared
LINKER_DEPENDENCIES=-lphpcpp -L/usr/local/FrontBase/lib/ -lFBCAccess
